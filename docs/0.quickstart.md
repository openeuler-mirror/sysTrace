...
- 安装依赖包
  ...
  [root@localhost sysTrace] yum install gcc g++ cmake make python3-devel protobuf-compiler protobuf-devel protobuf-c-devel libbpf clang libbpf-devel bpftool  elfutils-devel elfutils-libelf-devel nlohmann-json-devel
  ``` 
...
python <path-to-sysTrace>/sysTrace/convert/convert_mem_to_flamegraph_for_cur.py <path-to-hbm_trace_xxx_rank0.pb> <output_file>
