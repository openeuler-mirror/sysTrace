...
class DegradationKSigmaNaiveParams(BaseModel):
    window_size: int = Field(10, ge=1, description="Initial sliding window size")
    k_sigma: float = Field(2.0, gt=0, description="Number of standard deviations for anomaly threshold")
    ...
    min_consecutive: int = Field(2, ge=1, description="Minimum consecutive anomaly signals to confirm an alert")
